...
・アルカノイド以外（キャメルトライ、クエスター等）では1パルス＝1ピクセルでは感度が低すぎで2から3ピクセル程度が適当のようです。デフォルトではHIGHモード側を3ピクセル移動に設定して、タイトルによってコードを書き換えたり感度設定をし直さなくてもスイッチを切り替えることで適切な感度になるようにしています。<br>
<br>
