...
・アルカノイド以外（キャメルトライ、クエスター等）では1パルス＝1ピクセルでは感度が低すぎてソフト側の感度をかなり上げる必要があるため、デフォルトではHIGHモード側を3ピクセル移動に設定して、タイトルによってコードを書き換えたり感度設定をし直さなくてもスイッチを切り替えることで適切な調整範囲になるようにしています。<br>
<br>
